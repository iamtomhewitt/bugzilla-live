...
/**
 * A request message for saving application properties to file.
 * 
 * @author Tom Hewitt
 * @since 2.3.1
 */
public class ApplicationSaveRequest extends ConfigRequest
{
	public ApplicationSaveRequest(Map<String, String> properties)
	{
