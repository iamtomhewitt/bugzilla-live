...
class Sender():
    ...
    def send_properties_message(self, properties, is_user_properties, successful, reason):
        """
        ...
        json_data = {}
        json_data['message'] = 'configresponse'
        json_data['operation'] = 'getconfiguser' if is_user_properties else 'getconfigapplication'
        json_data['successful'] = 'yes' if successful else 'no'
        json_data['failurereason'] = reason
