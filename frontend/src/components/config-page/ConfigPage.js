    ...
    render() {
        return (
            <div id="config-container">
                ...
                {this.state.bugzillaUrl != null
                    && (
                        <div id="config">
                            ...
                            <div>
                                <input id="config-input" onChange={this.handleContentChange} name="content" type="text" value={this.state.bugzillaUrl} />
                            </div>
                        </div>
                    )}
                ...
                <div id="swagger">
                    Backend API documentation can be found<a href="http://localhost:8080/swagger-ui.html"> here</a>.
                </div>
            </div>
        );
    }
